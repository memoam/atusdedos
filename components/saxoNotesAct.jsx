...
export default function SaxoNotesAct() {
  ...
  const start = () => {
    ...
    setNote(saxoNotes[randomId]);
    setOption([saxoNotes[randomIdAsw], saxoNotes[randomId], saxoNotes[randomIdAswt]].sort(function () { return Math.random() - 0.5 }));
    setPlaying(true);
  }
  const isItOk = () => {
    ...
    <div className={styles.dashboard}>
      {!playing ? (
        <div className={styles.courseGuitar__actFalse}>
          <div>
            ...
            <div className={styles.courseGuitar__actFalse_atc}>
              ...
              <Image unoptimized loader={({ src }) => src} src="https://res.cloudinary.com/atusdedos/image/upload/v1666412615/saxofon/saxoNoteActEx_mlpkqt.png" alt="play" width={550} height={250} />
            </div>
          </div>
        ...
        <div className={styles.noteAct}>
          <div className={styles.noteAct__options}>
            {option.map((value, index) => {
              ...
              return (
                <button type="button" onClick={() => setAnswer(value.name)} className={value.name === answers ? styles.noteAct__options_active : null} key={keyIndex}>
                  <Image unoptimized loader={({ src }) => src} src={value.img} alt="play" width={179} height={410} />
