...
export default function PianoNotesAct() {
  ...
  const start = () => {
    ...
    setNote(pianoNotes[randomId]);
    setOption([pianoNotes[randomIdAsw], pianoNotes[randomId], pianoNotes[randomIdAswt]].sort(function () { return Math.random() - 0.5 }));
    setPlaying(true);
  }
  const isItOk = () => {
