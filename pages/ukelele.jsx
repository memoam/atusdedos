  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.main}>
        ...
        <p className={styles.main__title2}>Ukelele</p>
        <div className={styles.main__text}>
          <div className={styles.main__text_txt}>
            <p>
              Hola querido estudiante espero que estés emocionado como yo por el proceso que vas a comenzar en este momento, te felicito 
              por la decisión de tomar clases de música, ya que esta experiencia será muy enriquecedora para tu vida y para tu desarrollo 
            ...
            <p>
              ...
              es así que con toda la alegría de mi corazón te presento este método de Ukulele que te ayudara y facilitara el proceso de aprender 
            ...
            <p>
              Espero de todo corazón que juntos hagamos de esta aventura una aventura extraordinaria puesto que te esperan por delante 
